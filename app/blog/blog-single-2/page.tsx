                ...
                <div>
                    <section className="page-header -image-portfolio">
                        <div className="page-header__bg overlay-black-50 z-index--1">
                            <Image width="0" height="0" sizes="100vw" className="initial-img" src="/img/page-header/bg-image-blog.jpg" alt="Page header" />
                        </div>
                                        ...
                                        <div className="col-12 pt-60 md:pt-40">
                                            <div className="row y-gap-32">
                                                <div className="col-sm-6">
                                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/img/blog/single-page/1.jpg" alt="image" className="initial-img rounded-8" />
                                                </div>
                                                <div className="col-sm-6">
                                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/img/blog/single-page/2.jpg" alt="image" className="initial-img rounded-8" />
                                                </div>
                                                <div className="col-12">
                                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} src="/img/blog/single-page/3.jpg" alt="image" className="initial-img rounded-8" />
                                                </div>
                                            </div>
                                        </div>
