                        ...
                        <div className="container">
                            <div className="row y-gap-32">
                                <div className="col-lg-4">
                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="initial-img" src="/img/portfolio/single/5/1.jpg" alt="image" />
                                </div>
                                <div className="col-lg-8">
                                    <Image width="0" height="0" sizes="100vw" style={{ width: "auto", height: "auto" }} className="initial-img" src="/img/portfolio/single/5/2.jpg" alt="image" />
                                </div>
                            </div>
                        </div>
                    </section>
